...
// Sometimes sounds do not come, come twice, or cut off.

public class GameActivity4p extends AppCompatActivity {
    ...
    private LinearLayout pileLayout0,pileLayout1,pileLayout2,pileLayout3;
    private FrameLayout handLayout0,handLayout1,handLayout2,handLayout3;
    ...
    private List<ImageView> player3Cards = new ArrayList<>();
    private TextView score0,score1,score2,score3,text_player0Name,text_player1Name,text_player2Name,text_player3Name,player0_speech,player1_speech,player2_speech,player3_speech,text_game_end,total_score,damageText0,damageText1,damageText2,damageText3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tikki_main_screen_4p);
        ...
        handLayout2 = findViewById(R.id.cards_container2);
        handLayout3 = findViewById(R.id.cards_container3);
        ...
        pileLayout2 = findViewById(R.id.pileLayout2);
        pileLayout3 = findViewById(R.id.pileLayout3);

        score0 = findViewById(R.id.player0_score);
        score1 = findViewById(R.id.player1_score);
        score2 = findViewById(R.id.player2_score);
        score3 = findViewById(R.id.player3_score);
        ...
        text_player2Name = findViewById(R.id.text_player2Name);
        text_player3Name = findViewById(R.id.text_player3Name);
        player0_speech = findViewById(R.id.player0_speech);
        player1_speech = findViewById(R.id.player1_speech);
        player2_speech = findViewById(R.id.player2_speech);
        player3_speech = findViewById(R.id.player3_speech);
        damageText0 = findViewById(R.id.damage_text0);
        damageText1 = findViewById(R.id.damage_text1);
        damageText2 = findViewById(R.id.damage_text2);
        damageText3 = findViewById(R.id.damage_text3);
        ...
        damageText2.setVisibility(View.GONE);
        damageText3.setVisibility(View.GONE);
        ...
        Player P3 = new RandomPlayer("P3");
        Player P4 = new RandomPlayer("P4");
        ...
        */
        ...
        quitButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(GameActivity4p.this, MainActivity.class);
    ...
    private void advanceGame() {
        ...
        if (!game.gameOver) {
            ...
            Boolean hasBrainBool = game.players.get(playerIndex).brains == null;
            ...
            if (oldRoundNumber == 0) {
                TextView player_speech;
                switch (playerIndex) {
                    case 0:
                        player_speech = player0_speech;
                        break;
                    case 1:
                        player_speech = player1_speech;
                        break;
                    case 2:
                        player_speech = player2_speech;
                        break;
                    case 3:
                        player_speech = player3_speech;
                        break;
                    default:
                        throw new IllegalArgumentException("Invalid player index: " + playerIndex);
                }
                applySpeechTextAnimation(player_speech, moveString, playerIndex);
            }
            ...
            if (oldRoundNumber != 0) {
                animateCardPlay(playerIndex, moveString);
                roundStarted = 0;
            }
    ...
    private void setScores() {
        ...
        String player2_score_string = Objects.requireNonNull(playerScores.get(players.get(2))).toString();
        String player3_score_string = Objects.requireNonNull(playerScores.get(players.get(3))).toString();

        CharSequence old_score0 = score0.getText();
        CharSequence old_score1 = score1.getText();
        CharSequence old_score2 = score2.getText();
        CharSequence old_score3 = score3.getText();
        score0.setText(player0_score_string);
        score1.setText(player1_score_string);
        score2.setText(player2_score_string);
        score3.setText(player3_score_string);
        ...
        if (!old_score2.equals(score2.getText())) {
            score2.startAnimation(winnerAnimation);
            int damage = subtractCharSequences(score2.getText(), old_score2);
            applyDamageNumberAnimation(damageText2, damage);
        }
        if (!old_score3.equals(score3.getText())) {
            score3.startAnimation(winnerAnimation);
            int damage = subtractCharSequences(score3.getText(), old_score3);
            applyDamageNumberAnimation(damageText3, damage);
        }
    ...
    private void animateCardPlay(int playerIndex, String playedCardName) {
        if(playerIndex != 0) {
            ...
            List<ImageView> handCards;
            switch (playerIndex) {
                case 0:
                    handCards = player0Cards;
                    break;
                case 1:
                    handCards = player1Cards;
                    break;
                case 2:
                    handCards = player2Cards;
                    break;
                case 3:
                    handCards = player3Cards;
                    break;
                default:
                    throw new IllegalArgumentException("Invalid player index: " + playerIndex);
            }
            ...
            switch (playerIndex) {
                case 0:
                    handLayout = handLayout0;
                    break;
                case 1:
                    handLayout = handLayout1;
                    break;
                case 2:
                    handLayout = handLayout2;
                    break;
                case 3:
                    handLayout = handLayout3;
                    break;
                default:
                    throw new IllegalArgumentException("Invalid player index: " + playerIndex);
            }
